import{a as e,c as t,l as n,r,u as i}from"./PageHeader-DYFs9Qsn.js";import{$ as a,$n as o,Cn as s,Gt as c,Kn as l,Ln as u,O as d,Q as f,Sn as p,U as m,V as h,Wn as g,Wt as _,Xn as v,Y as y,_n as b,an as x,bn as S,et as C,gr as w,ln as T,qn as E,rn as D,tt as O,un as k,vn as A,xn as j,yr as M,z as N}from"./index-CFAzko4H.js";var P=typeof document<`u`&&typeof window<`u`,{cubicBezierEaseInOut:F}=C;function I({duration:e=`.2s`,delay:t=`.1s`}={}){return[b(`&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to`,{opacity:1}),b(`&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from`,`
 opacity: 0!important;
...
`),R=g({name:`BaseWave`,props:{clsPrefix:{type:String,required:!0}},setup(e){a(`-base-wave`,L,M(e,`clsPrefix`));let t=w(null),n=w(!1),r=null;return o(()=>{r!==null&&window.clearTimeout(r)}),{active:n,selfRef:t,play(){r!==null&&(window.clearTimeout(r),n.value=!1,r=null),v(()=>{var e;(e=t.value)==null||e.offsetHeight,n.value=!0,r=window.setTimeout(()=>{n.value=!1,r=null},1e3)})}}},render(){let{clsPrefix:e}=this;return l(`div`,{ref:`selfRef`,"aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),z=P&&`chrome`in window;P&&navigator.userAgent.includes(`Firefox`);var B=P&&navigator.userAgent.includes(`Safari`)&&!z;function V(e){return k(e,[255,255,255,.16])}function H(e){return k(e,[0,0,0,.12])}var U=D(`n-button-group`),W=b([A(`button`,`
 ...
 `,[j(`active`,{zIndex:1,animationName:`button-wave-spread, button-wave-opacity`})]),P&&`MozBoxSizing`in document.createElement(`div`).style?b(`&::moz-focus-inner`,{border:0}):null,S(`border, state-border`,`
 position: absolute;
 left: 0;
 top: 0;
 right: 0;
