...
`,[Q(`strong`,`
 ...
 `,[X(`base-loading`,`
 color: var(--n-loading-color);
 `),X(`base-selection-tags`,`min-height: var(--n-height);`),H(`border, state-border`,`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
 ...
 `)]),H(`render-label`,`
 color: var(--n-text-color);
 `)]),I(`disabled`,[z(`&:hover`,[H(`state-border`,`
 ...
 `),X(`base-selection-label`,`background-color: var(--n-color-active);`),X(`base-selection-tags`,`background-color: var(--n-color-active);`)])]),Q(`disabled`,`cursor: not-allowed;`,[H(`arrow`,`
 ...
 opacity: 0;
 `)]),[`warning`,`error`].map(e=>Q(`${e}-status`,[H(`state-border`,`border: var(--n-border-${e});`),I(`disabled`,[z(`&:hover`,[H(`state-border`,`
 box-shadow: var(--n-box-shadow-hover-${e});
 border: var(--n-border-hover-${e});
 `)]),Q(`active`,[H(`state-border`,`
 box-shadow: var(--n-box-shadow-active-${e});
 border: var(--n-border-active-${e});
 `),X(`base-selection-label`,`background-color: var(--n-color-active-${e});`),X(`base-selection-tags`,`background-color: var(--n-color-active-${e});`)]),Q(`focus`,[H(`state-border`,`
