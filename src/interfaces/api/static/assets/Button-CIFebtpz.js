import{a as e,c as t,l as n,r,u as i}from"./PageHeader-CL9q7qjr.js";import{$ as a,$n as o,Cn as s,Gt as c,Kn as l,Ln as u,O as d,Q as f,Sn as p,U as m,V as h,Wn as g,Wt as _,Xn as v,Y as y,_n as b,an as x,bn as S,et as C,hr as w,ln as T,qn as E,rn as D,tt as O,un as k,vn as A,vr as j,xn as M,z as N}from"./index-D2m1fciL.js";var P=typeof document<`u`&&typeof window<`u`,{cubicBezierEaseInOut:F}=C;function I({duration:e=`.2s`,delay:t=`.1s`}={}){return[b(`&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to`,{opacity:1}),b(`&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from`,`
 opacity: 0!important;
