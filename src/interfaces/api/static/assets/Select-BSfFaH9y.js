...
`,[G(`scrollbar`,`
 ...
 transition: color .3s var(--n-bezier);
 `,[j({enterScale:`0.5`})])])]),vt=Z({name:`InternalSelectMenu`,props:Object.assign(Object.assign({},H.props),{clsPrefix:{type:String,required:!0},scrollable:{type:Boolean,default:!0},treeMate:{type:Object,required:!0},multiple:Boolean,size:{type:String,default:`medium`},value:{type:[String,Number,Array],default:null},autoPending:Boolean,virtualScroll:{type:Boolean,default:!0},show:{type:Boolean,default:!0},labelField:{type:String,default:`label`},valueField:{type:String,default:`value`},loading:Boolean,focusable:Boolean,renderLabel:Function,renderOption:Function,nodeProps:Function,showCheckmark:{type:Boolean,default:!0},onMousedown:Function,onScroll:Function,onFocus:Function,onBlur:Function,onKeyup:Function,onKeydown:Function,onTabOut:Function,onMouseenter:Function,onMouseleave:Function,onResize:Function,resetMenuOnOptionsChange:{type:Boolean,default:!0},inlineThemeDisabled:Boolean,scrollbarProps:Object,onToggle:Function}),setup(e){let{mergedClsPrefixRef:t,mergedRtlRef:n,mergedComponentPropsRef:r}=ye(e),i=b(`InternalSelectMenu`,n,t),a=H(`InternalSelectMenu`,`-internal-select-menu`,_t,ie,e,R(e,`clsPrefix`)),s=W(null),c=W(null),l=W(null),u=N(()=>e.treeMate.getFlattenedNodes()),d=N(()=>qe(u.value)),p=W(null);function _(){let{treeMate:t}=e,n=null,{value:r}=e;r===null?n=t.getFirstAvailableNode():(n=e.multiple?t.getNode((r||[])[(r||[]).length-1]):t.getNode(r),(!n||n.disabled)&&(n=t.getFirstAvailableNode())),I(n||null)}function v(){let{value:t}=p;t&&!e.treeMate.getNode(t.key)&&(p.value=null)}let y;ue(()=>e.show,t=>{t?y=ue(()=>e.treeMate,()=>{e.resetMenuOnOptionsChange?(e.autoPending?_():v(),pe(ae)):v()},{immediate:!0}):y?.()},{immediate:!0}),me(()=>{y?.()});let x=N(()=>m(a.value.self[q(`optionHeight`,e.size)])),S=N(()=>h(a.value.self[q(`padding`,e.size)])),C=N(()=>e.multiple&&Array.isArray(e.value)?new Set(e.value):new Set),w=N(()=>{let e=u.value;return e&&e.length===0}),T=N(()=>r?.value?.Select?.renderEmpty);function E(t){let{onToggle:n}=e;n&&n(t)}function ee(t){let{onScroll:n}=e;n&&n(t)}function D(e){var t;(t=l.value)==null||t.sync(),ee(e)}function O(){var e;(e=l.value)==null||e.sync()}function k(){let{value:e}=p;return e||null}function te(e,t){t.disabled||I(t,!1)}function j(e,t){t.disabled||E(t)}function M(t){var n;A(t,`action`)||(n=e.onKeyup)==null||n.call(e,t)}function ne(t){var n;A(t,`action`)||(n=e.onKeydown)==null||n.call(e,t)}function re(t){var n;(n=e.onMousedown)==null||n.call(e,t),!e.focusable&&t.preventDefault()}function P(){let{value:e}=p;e&&I(e.getNext({loop:!0}),!0)}function F(){let{value:e}=p;e&&I(e.getPrev({loop:!0}),!0)}function I(e,t=!1){p.value=e,t&&ae()}function ae(){var t,n;let r=p.value;if(!r)return;let i=d.value(r.key);i!==null&&(e.virtualScroll?(t=c.value)==null||t.scrollTo({index:i}):(n=l.value)==null||n.scrollTo({index:i,elSize:x.value}))}function oe(t){var n;s.value?.contains(t.target)&&((n=e.onFocus)==null||n.call(e,t))}function L(t){var n;s.value?.contains(t.relatedTarget)||(n=e.onBlur)==null||n.call(e,t)}ve(f,{handleOptionMouseEnter:te,handleOptionClick:j,valueSetRef:C,pendingTmNodeRef:p,nodePropsRef:R(e,`nodeProps`),showCheckmarkRef:R(e,`showCheckmark`),multipleRef:R(e,`multiple`),valueRef:R(e,`value`),renderLabelRef:R(e,`renderLabel`),renderOptionRef:R(e,`renderOption`),labelFieldRef:R(e,`labelField`),valueFieldRef:R(e,`valueField`)}),ve(o,s),fe(()=>{let{value:e}=l;e&&e.sync()});let z=N(()=>{let{size:t}=e,{common:{cubicBezierEaseInOut:n},self:{height:r,borderRadius:i,color:o,groupHeaderTextColor:s,actionDividerColor:c,optionTextColorPressed:l,optionTextColor:u,optionTextColorDisabled:d,optionTextColorActive:f,optionOpacityDisabled:p,optionCheckColor:m,actionTextColor:g,optionColorPending:_,optionColorActive:v,loadingColor:y,loadingSize:b,optionColorActivePending:x,[q(`optionFontSize`,t)]:S,[q(`optionHeight`,t)]:C,[q(`optionPadding`,t)]:w}}=a.value;return{"--n-height":r,"--n-action-divider-color":c,"--n-action-text-color":g,"--n-bezier":n,"--n-border-radius":i,"--n-color":o,"--n-option-font-size":S,"--n-group-header-text-color":s,"--n-option-check-color":m,"--n-option-color-pending":_,"--n-option-color-active":v,"--n-option-color-active-pending":x,"--n-option-height":C,"--n-option-opacity-disabled":p,"--n-option-text-color":u,"--n-option-text-color-active":f,"--n-option-text-color-disabled":d,"--n-option-text-color-pressed":l,"--n-option-padding":w,"--n-option-padding-left":h(w,`left`),"--n-option-padding-right":h(w,`right`),"--n-loading-color":y,"--n-loading-size":b}}),{inlineThemeDisabled:B}=e,V=B?g(`internal-select-menu`,N(()=>e.size[0]),z,e):void 0,U={selfRef:s,next:P,prev:F,getPendingTmNode:k};return Ce(s,e.onResize),Object.assign({mergedTheme:a,mergedClsPrefix:t,rtlEnabled:i,virtualListRef:c,scrollbarRef:l,itemSize:x,padding:S,flattenedNodes:u,empty:w,mergedRenderEmpty:T,virtualListContainer(){let{value:e}=c;return e?.listElRef},virtualListContent(){let{value:e}=c;return e?.itemsElRef},doScroll:ee,handleFocusin:oe,handleFocusout:L,handleKeyUp:M,handleKeyDown:ne,handleMouseDown:re,handleVirtualListResize:O,handleVirtualListScroll:D,cssVars:B?void 0:z,themeClass:V?.themeClass,onRender:V?.onRender},U)},render(){let{$slots:e,virtualScroll:t,clsPrefix:r,mergedTheme:i,themeClass:a,onRender:o}=this;return o?.(),X(`div`,{ref:`selfRef`,tabindex:this.focusable?0:-1,class:[`${r}-base-select-menu`,`${r}-base-select-menu--${this.size}-size`,this.rtlEnabled&&`${r}-base-select-menu--rtl`,a,this.multiple&&`${r}-base-select-menu--multiple`],style:this.cssVars,onFocusin:this.handleFocusin,onFocusout:this.handleFocusout,onKeyup:this.handleKeyUp,onKeydown:this.handleKeyDown,onMousedown:this.handleMouseDown,onMouseenter:this.onMouseenter,onMouseleave:this.onMouseleave},n(e.header,e=>e&&X(`div`,{class:`${r}-base-select-menu__header`,"data-header":!0,key:`header`},e)),this.loading?X(`div`,{class:`${r}-base-select-menu__loading`},X(v,{clsPrefix:r,strokeWidth:20})):this.empty?X(`div`,{class:`${r}-base-select-menu__empty`,"data-empty":!0},T(e.empty,()=>[this.mergedRenderEmpty?.call(this)||X(pt,{theme:i.peers.Empty,themeOverrides:i.peerOverrides.Empty,size:this.size})])):X(_,Object.assign({ref:`scrollbarRef`,theme:i.peers.Scrollbar,themeOverrides:i.peerOverrides.Scrollbar,scrollable:this.scrollable,container:t?this.virtualListContainer:void 0,content:t?this.virtualListContent:void 0,onScroll:t?void 0:this.doScroll},this.scrollbarProps),{default:()=>t?X(D,{ref:`virtualListRef`,class:`${r}-virtual-list`,items:this.flattenedNodes,itemSize:this.itemSize,showScrollbar:!1,paddingTop:this.padding.top,paddingBottom:this.padding.bottom,onResize:this.handleVirtualListResize,onScroll:this.handleVirtualListScroll,itemResizable:!0},{default:({item:e})=>e.isGroup?X(mt,{key:e.key,clsPrefix:r,tmNode:e}):e.ignored?null:X(gt,{clsPrefix:r,key:e.key,tmNode:e})}):X(`div`,{class:`${r}-base-select-menu-option-wrapper`,style:{paddingTop:this.padding.top,paddingBottom:this.padding.bottom}},this.flattenedNodes.map(e=>e.isGroup?X(mt,{key:e.key,clsPrefix:r,tmNode:e}):X(gt,{clsPrefix:r,key:e.key,tmNode:e})))}),n(e.action,e=>e&&[X(`div`,{class:`${r}-base-select-menu__action`,"data-action":!0,key:`action`},e),X(O,{onFocus:this.onTabOut,key:`focus-detector`})]))}});function yt(e){let{textColor2:t,primaryColorHover:n,primaryColorPressed:r,primaryColor:i,infoColor:a,successColor:o,warningColor:s,errorColor:c,baseColor:l,borderColor:u,opacityDisabled:d,tagColor:f,closeIconColor:p,closeIconColorHover:m,closeIconColorPressed:h,borderRadiusSmall:g,fontSizeMini:_,fontSizeTiny:v,fontSizeSmall:y,fontSizeMedium:b,heightMini:x,heightTiny:S,heightSmall:C,heightMedium:w,closeColorHover:T,closeColorPressed:E,buttonColor2Hover:ee,buttonColor2Pressed:D,fontWeightStrong:O}=e;return Object.assign(Object.assign({},le),{closeBorderRadius:g,heightTiny:x,heightSmall:S,heightMedium:C,heightLarge:w,borderRadius:g,opacityDisabled:d,fontSizeTiny:_,fontSizeSmall:v,fontSizeMedium:y,fontSizeLarge:b,fontWeightStrong:O,textColorCheckable:t,textColorHoverCheckable:t,textColorPressedCheckable:t,textColorChecked:l,colorCheckable:`#0000`,colorHoverCheckable:ee,colorPressedCheckable:D,colorChecked:i,colorCheckedHover:n,colorCheckedPressed:r,border:`1px solid ${u}`,textColor:t,color:f,colorBordered:`rgb(250, 250, 252)`,closeIconColor:p,closeIconColorHover:m,closeIconColorPressed:h,closeColorHover:T,closeColorPressed:E,borderPrimary:`1px solid ${K(i,{alpha:.3})}`,textColorPrimary:i,colorPrimary:K(i,{alpha:.12}),colorBorderedPrimary:K(i,{alpha:.1}),closeIconColorPrimary:i,closeIconColorHoverPrimary:i,closeIconColorPressedPrimary:i,closeColorHoverPrimary:K(i,{alpha:.12}),closeColorPressedPrimary:K(i,{alpha:.18}),borderInfo:`1px solid ${K(a,{alpha:.3})}`,textColorInfo:a,colorInfo:K(a,{alpha:.12}),colorBorderedInfo:K(a,{alpha:.1}),closeIconColorInfo:a,closeIconColorHoverInfo:a,closeIconColorPressedInfo:a,closeColorHoverInfo:K(a,{alpha:.12}),closeColorPressedInfo:K(a,{alpha:.18}),borderSuccess:`1px solid ${K(o,{alpha:.3})}`,textColorSuccess:o,colorSuccess:K(o,{alpha:.12}),colorBorderedSuccess:K(o,{alpha:.1}),closeIconColorSuccess:o,closeIconColorHoverSuccess:o,closeIconColorPressedSuccess:o,closeColorHoverSuccess:K(o,{alpha:.12}),closeColorPressedSuccess:K(o,{alpha:.18}),borderWarning:`1px solid ${K(s,{alpha:.35})}`,textColorWarning:s,colorWarning:K(s,{alpha:.15}),colorBorderedWarning:K(s,{alpha:.12}),closeIconColorWarning:s,closeIconColorHoverWarning:s,closeIconColorPressedWarning:s,closeColorHoverWarning:K(s,{alpha:.12}),closeColorPressedWarning:K(s,{alpha:.18}),borderError:`1px solid ${K(c,{alpha:.23})}`,textColorError:c,colorError:K(c,{alpha:.1}),colorBorderedError:K(c,{alpha:.08}),closeIconColorError:c,closeIconColorHoverError:c,closeIconColorPressedError:c,closeColorHoverError:K(c,{alpha:.12}),closeColorPressedError:K(c,{alpha:.18})})}var bt={name:`Tag`,common:P,self:yt},xt={color:Object,type:{type:String,default:`default`},round:Boolean,size:String,closable:Boolean,disabled:{type:Boolean,default:void 0}},St=G(`tag`,`
...
`,[z(`strong`,`
 ...
 `,[V(`disabled`,[U(`&:hover`,`background-color: var(--n-color-checked-hover);`),U(`&:active`,`background-color: var(--n-color-checked-pressed);`)])])])]),Ct=Object.assign(Object.assign(Object.assign({},H.props),xt),{bordered:{type:Boolean,default:void 0},checked:Boolean,checkable:Boolean,strong:Boolean,triggerClickOnClose:Boolean,onClose:[Array,Function],onMouseenter:Function,onMouseleave:Function,"onUpdate:checked":Function,onUpdateChecked:Function,internalCloseFocusable:{type:Boolean,default:!0},internalCloseIsButtonTag:{type:Boolean,default:!0},onCheckedChange:Function}),wt=oe(`n-tag`),Tt=Z({name:`Tag`,props:Ct,slots:Object,setup(e){let t=W(null),{mergedBorderedRef:n,mergedClsPrefixRef:r,inlineThemeDisabled:i,mergedRtlRef:a,mergedComponentPropsRef:o}=ye(e),s=N(()=>e.size||o?.value?.Tag?.size||`medium`),c=H(`Tag`,`-tag`,St,bt,e,r);ve(wt,{roundRef:R(e,`round`)});function l(){if(!e.disabled&&e.checkable){let{checked:t,onCheckedChange:n,onUpdateChecked:r,"onUpdate:checked":i}=e;r&&r(!t),i&&i(!t),n&&n(!t)}}function u(t){if(e.triggerClickOnClose||t.stopPropagation(),!e.disabled){let{onClose:n}=e;n&&w(n,t)}}let f={setTextContent(e){let{value:n}=t;n&&(n.textContent=e)}},p=b(`Tag`,a,r),m=N(()=>{let{type:t,color:{color:r,textColor:i}={}}=e,a=s.value,{common:{cubicBezierEaseInOut:o},self:{padding:l,closeMargin:u,borderRadius:d,opacityDisabled:f,textColorCheckable:p,textColorHoverCheckable:m,textColorPressedCheckable:g,textColorChecked:_,colorCheckable:v,colorHoverCheckable:y,colorPressedCheckable:b,colorChecked:x,colorCheckedHover:S,colorCheckedPressed:C,closeBorderRadius:w,fontWeightStrong:T,[q(`colorBordered`,t)]:E,[q(`closeSize`,a)]:ee,[q(`closeIconSize`,a)]:D,[q(`fontSize`,a)]:O,[q(`height`,a)]:k,[q(`color`,t)]:te,[q(`textColor`,t)]:A,[q(`border`,t)]:j,[q(`closeIconColor`,t)]:M,[q(`closeIconColorHover`,t)]:ne,[q(`closeIconColorPressed`,t)]:re,[q(`closeColorHover`,t)]:N,[q(`closeColorPressed`,t)]:P}}=c.value,F=h(u);return{"--n-font-weight-strong":T,"--n-avatar-size-override":`calc(${k} - 8px)`,"--n-bezier":o,"--n-border-radius":d,"--n-border":j,"--n-close-icon-size":D,"--n-close-color-pressed":P,"--n-close-color-hover":N,"--n-close-border-radius":w,"--n-close-icon-color":M,"--n-close-icon-color-hover":ne,"--n-close-icon-color-pressed":re,"--n-close-icon-color-disabled":M,"--n-close-margin-top":F.top,"--n-close-margin-right":F.right,"--n-close-margin-bottom":F.bottom,"--n-close-margin-left":F.left,"--n-close-size":ee,"--n-color":r||(n.value?E:te),"--n-color-checkable":v,"--n-color-checked":x,"--n-color-checked-hover":S,"--n-color-checked-pressed":C,"--n-color-hover-checkable":y,"--n-color-pressed-checkable":b,"--n-font-size":O,"--n-height":k,"--n-opacity-disabled":f,"--n-padding":l,"--n-text-color":i||A,"--n-text-color-checkable":p,"--n-text-color-checked":_,"--n-text-color-hover-checkable":m,"--n-text-color-pressed-checkable":g}}),_=i?g(`tag`,N(()=>{let t=``,{type:r,color:{color:i,textColor:a}={}}=e;return t+=r[0],t+=s.value[0],i&&(t+=`a${d(i)}`),a&&(t+=`b${d(a)}`),n.value&&(t+=`c`),t}),m,e):void 0;return Object.assign(Object.assign({},f),{rtlEnabled:p,mergedClsPrefix:r,contentRef:t,mergedBordered:n,handleClick:l,handleCloseClick:u,cssVars:i?void 0:m,themeClass:_?.themeClass,onRender:_?.onRender})},render(){var e;let{mergedClsPrefix:t,rtlEnabled:r,closable:i,color:{borderColor:a}={},round:o,onRender:s,$slots:c}=this;s?.();let l=n(c.avatar,e=>e&&X(`div`,{class:`${t}-tag__avatar`},e)),u=n(c.icon,e=>e&&X(`div`,{class:`${t}-tag__icon`},e));return X(`div`,{class:[`${t}-tag`,this.themeClass,{[`${t}-tag--rtl`]:r,[`${t}-tag--strong`]:this.strong,[`${t}-tag--disabled`]:this.disabled,[`${t}-tag--checkable`]:this.checkable,[`${t}-tag--checked`]:this.checkable&&this.checked,[`${t}-tag--round`]:o,[`${t}-tag--avatar`]:l,[`${t}-tag--icon`]:u,[`${t}-tag--closable`]:i}],style:this.cssVars,onClick:this.handleClick,onMouseenter:this.onMouseenter,onMouseleave:this.onMouseleave},u||l,X(`span`,{class:`${t}-tag__content`,ref:`contentRef`},(e=this.$slots).default?.call(e)),!this.checkable&&i?X(Ae,{clsPrefix:t,class:`${t}-tag__close`,disabled:this.disabled,onClick:this.handleCloseClick,focusable:this.internalCloseFocusable,round:o,isButtonTag:this.internalCloseIsButtonTag,absolute:!0}):null,!this.checkable&&this.mergedBordered?X(`div`,{class:`${t}-tag__border`,style:{borderColor:a}}):null)}}),Et=U([G(`base-selection`,`
 ...
 `,[j({originalTransition:`background-color .3s var(--n-bezier), box-shadow .3s var(--n-bezier)`})])]),Ft=Z({name:`Select`,props:Object.assign(Object.assign({},H.props),{to:s.propTo,bordered:{type:Boolean,default:void 0},clearable:Boolean,clearCreatedOptionsOnClear:{type:Boolean,default:!0},clearFilterAfterSelect:{type:Boolean,default:!0},options:{type:Array,default:()=>[]},defaultValue:{type:[String,Number,Array],default:null},keyboard:{type:Boolean,default:!0},value:[String,Number,Array],placeholder:String,menuProps:Object,multiple:Boolean,size:String,menuSize:{type:String},filterable:Boolean,disabled:{type:Boolean,default:void 0},remote:Boolean,loading:Boolean,filter:Function,placement:{type:String,default:`bottom-start`},widthMode:{type:String,default:`trigger`},tag:Boolean,onCreate:Function,fallbackOption:{type:[Function,Boolean],default:void 0},show:{type:Boolean,default:void 0},showArrow:{type:Boolean,default:!0},maxTagCount:[Number,String],ellipsisTagPopoverProps:Object,consistentMenuWidth:{type:Boolean,default:!0},virtualScroll:{type:Boolean,default:!0},labelField:{type:String,default:`label`},valueField:{type:String,default:`value`},childrenField:{type:String,default:`children`},renderLabel:Function,renderOption:Function,renderTag:Function,"onUpdate:value":[Function,Array],inputProps:Object,nodeProps:Function,ignoreComposition:{type:Boolean,default:!0},showOnFocus:Boolean,onUpdateValue:[Function,Array],onBlur:[Function,Array],onClear:[Function,Array],onFocus:[Function,Array],onScroll:[Function,Array],onSearch:[Function,Array],onUpdateShow:[Function,Array],"onUpdate:show":[Function,Array],displayDirective:{type:String,default:`show`},resetMenuOnOptionsChange:{type:Boolean,default:!0},status:String,showCheckmark:{type:Boolean,default:!0},scrollbarProps:Object,onChange:[Function,Array],items:Array}),slots:Object,setup(t){let{mergedClsPrefixRef:n,mergedBorderedRef:r,namespaceRef:i,inlineThemeDisabled:o,mergedComponentPropsRef:c}=ye(t),l=H(`Select`,`-select`,Pt,be,t,n),u=W(t.defaultValue),d=a(R(t,`value`),u),f=W(!1),m=W(``),h=re(t,[`items`,`options`]),_=W([]),v=W([]),y=N(()=>v.value.concat(_.value).concat(h.value)),b=N(()=>{let{filter:e}=t;if(e)return e;let{labelField:n,valueField:r}=t;return(e,t)=>{if(!t)return!1;let i=t[n];if(typeof i==`string`)return At(e,i);let a=t[r];return typeof a==`string`?At(e,a):typeof a==`number`?At(e,String(a)):!1}}),S=N(()=>{if(t.remote)return h.value;{let{value:e}=y,{value:n}=m;return!n.length||!t.filterable?e:Mt(e,b.value,n,t.childrenField)}}),C=N(()=>{let{valueField:e,childrenField:n}=t,r=jt(e,n);return dt(S.value,r)}),T=N(()=>Nt(y.value,t.valueField,t.childrenField)),D=W(!1),O=a(R(t,`show`),D),k=W(null),te=W(null),j=W(null),{localeRef:M}=E(`Select`),ne=N(()=>t.placeholder??M.value.placeholder),P=[],F=W(new Map),ie=N(()=>{let{fallbackOption:e}=t;if(e===void 0){let{labelField:e,valueField:n}=t;return t=>({[e]:String(t),[n]:t})}return e===!1?!1:t=>Object.assign(e(t),{value:t})});function I(e){let n=t.remote,{value:r}=F,{value:i}=T,{value:a}=ie,o=[];return e.forEach(e=>{if(i.has(e))o.push(i.get(e));else if(n&&r.has(e))o.push(r.get(e));else if(a){let t=a(e);t&&o.push(t)}}),o}let ae=N(()=>{if(t.multiple){let{value:e}=d;return Array.isArray(e)?I(e):[]}return null}),oe=N(()=>{let{value:e}=d;return!t.multiple&&!Array.isArray(e)?e===null?null:I([e])[0]||null:null}),L=x(t,{mergedSize:e=>{let{size:n}=t;if(n)return n;let{mergedSize:r}=e||{};return r?.value?r.value:c?.value?.Select?.size||`medium`}}),{mergedSizeRef:z,mergedDisabledRef:B,mergedStatusRef:V}=L;function U(e,n){let{onChange:r,"onUpdate:value":i,onUpdateValue:a}=t,{nTriggerFormChange:o,nTriggerFormInput:s}=L;r&&w(r,e,n),a&&w(a,e,n),i&&w(i,e,n),u.value=e,o(),s()}function G(e){let{onBlur:n}=t,{nTriggerFormBlur:r}=L;n&&w(n,e),r()}function se(){let{onClear:e}=t;e&&w(e)}function ce(e){let{onFocus:n,showOnFocus:r}=t,{nTriggerFormFocus:i}=L;n&&w(n,e),i(),r&&J()}function K(e){let{onSearch:n}=t;n&&w(n,e)}function q(e){let{onScroll:n}=t;n&&w(n,e)}function le(){var e;let{remote:n,multiple:r}=t;if(n){let{value:n}=F;if(r){let{valueField:r}=t;(e=ae.value)==null||e.forEach(e=>{n.set(e[r],e)})}else{let e=oe.value;e&&n.set(e[t.valueField],e)}}}function de(e){let{onUpdateShow:n,"onUpdate:show":r}=t;n&&w(n,e),r&&w(r,e),D.value=e}function J(){B.value||(de(!0),D.value=!0,t.filterable&&je())}function Y(){de(!1)}function fe(){m.value=``,v.value=P}let X=W(!1);function pe(){t.filterable&&(X.value=!0)}function me(){t.filterable&&(X.value=!1,O.value||fe())}function he(){B.value||(O.value?t.filterable?je():Y():J())}function ge(e){(j.value?.selfRef)?.contains(e.relatedTarget)||(f.value=!1,G(e),Y())}function Z(e){ce(e),f.value=!0}function _e(){f.value=!0}function ve(e){k.value?.$el.contains(e.relatedTarget)||(f.value=!1,G(e),Y())}function Q(){var e;(e=k.value)==null||e.focus(),Y()}function xe(t){O.value&&(k.value?.$el.contains(e(t))||Y())}function Se(e){if(!Array.isArray(e))return[];if(ie.value)return Array.from(e);{let{remote:n}=t,{value:r}=T;if(n){let{value:t}=F;return e.filter(e=>r.has(e)||t.has(e))}else return e.filter(e=>r.has(e))}}function Ce(e){we(e.rawNode)}function we(e){if(B.value)return;let{tag:n,remote:r,clearFilterAfterSelect:i,valueField:a}=t;if(n&&!r){let{value:e}=v,t=e[0]||null;if(t){let e=_.value;e.length?e.push(t):_.value=[t],v.value=P}}if(r&&F.value.set(e[a],e),t.multiple){let t=Se(d.value),o=t.findIndex(t=>t===e[a]);if(~o){if(t.splice(o,1),n&&!r){let t=Te(e[a]);~t&&(_.value.splice(t,1),i&&(m.value=``))}}else t.push(e[a]),i&&(m.value=``);U(t,I(t))}else{if(n&&!r){let t=Te(e[a]);~t?_.value=[_.value[t]]:_.value=P}Ae(),Y(),U(e[a],e)}}function Te(e){return _.value.findIndex(n=>n[t.valueField]===e)}function $(e){O.value||J();let{value:n}=e.target;m.value=n;let{tag:r,remote:i}=t;if(K(n),r&&!i){if(!n){v.value=P;return}let{onCreate:e}=t,r=e?e(n):{[t.labelField]:n,[t.valueField]:n},{valueField:i,labelField:a}=t;h.value.some(e=>e[i]===r[i]||e[a]===r[a])||_.value.some(e=>e[i]===r[i]||e[a]===r[a])?v.value=P:v.value=[r]}}function Ee(e){e.stopPropagation();let{multiple:n,tag:r,remote:i,clearCreatedOptionsOnClear:a}=t;!n&&t.filterable&&Y(),r&&!i&&a&&(_.value=P),se(),n?U([],[]):U(null,null)}function De(e){!A(e,`action`)&&!A(e,`empty`)&&!A(e,`header`)&&e.preventDefault()}function Oe(e){q(e)}function ke(e){var n,r,i;if(!t.keyboard){e.preventDefault();return}switch(e.key){case` `:if(t.filterable)break;e.preventDefault();case`Enter`:if(!k.value?.isComposing){if(O.value){let e=j.value?.getPendingTmNode();e?Ce(e):t.filterable||(Y(),Ae())}else if(J(),t.tag&&X.value){let e=v.value[0];if(e){let n=e[t.valueField],{value:r}=d;t.multiple&&Array.isArray(r)&&r.includes(n)||we(e)}}}e.preventDefault();break;case`ArrowUp`:if(e.preventDefault(),t.loading)return;O.value&&((n=j.value)==null||n.prev());break;case`ArrowDown`:if(e.preventDefault(),t.loading)return;O.value?(r=j.value)==null||r.next():J();break;case`Escape`:O.value&&(ee(e),Y()),(i=k.value)==null||i.focus();break}}function Ae(){var e;(e=k.value)==null||e.focus()}function je(){var e;(e=k.value)==null||e.focusInput()}function Me(){var e;O.value&&((e=te.value)==null||e.syncPosition())}le(),ue(R(t,`options`),le);let Ne={focus:()=>{var e;(e=k.value)==null||e.focus()},focusInput:()=>{var e;(e=k.value)==null||e.focusInput()},blur:()=>{var e;(e=k.value)==null||e.blur()},blurInput:()=>{var e;(e=k.value)==null||e.blurInput()}},Pe=N(()=>{let{self:{menuBoxShadow:e}}=l.value;return{"--n-menu-box-shadow":e}}),Fe=o?g(`select`,void 0,Pe,t):void 0;return Object.assign(Object.assign({},Ne),{mergedStatus:V,mergedClsPrefix:n,mergedBordered:r,namespace:i,treeMate:C,isMounted:p(),triggerRef:k,menuRef:j,pattern:m,uncontrolledShow:D,mergedShow:O,adjustedTo:s(t),uncontrolledValue:u,mergedValue:d,followerRef:te,localizedPlaceholder:ne,selectedOption:oe,selectedOptions:ae,mergedSize:z,mergedDisabled:B,focused:f,activeWithoutMenuOpen:X,inlineThemeDisabled:o,onTriggerInputFocus:pe,onTriggerInputBlur:me,handleTriggerOrMenuResize:Me,handleMenuFocus:_e,handleMenuBlur:ve,handleMenuTabOut:Q,handleTriggerClick:he,handleToggle:Ce,handleDeleteOption:we,handlePatternInput:$,handleClear:Ee,handleTriggerBlur:ge,handleTriggerFocus:Z,handleKeydown:ke,handleMenuAfterLeave:fe,handleMenuClickOutside:xe,handleMenuScroll:Oe,handleMenuKeydown:ke,handleMenuMousedown:De,mergedTheme:l,cssVars:o?void 0:Pe,themeClass:Fe?.themeClass,onRender:Fe?.onRender})},render(){return X(`div`,{class:`${this.mergedClsPrefix}-select`},X(i,null,{default:()=>[X(u,null,{default:()=>X(Dt,{ref:`triggerRef`,inlineThemeDisabled:this.inlineThemeDisabled,status:this.mergedStatus,inputProps:this.inputProps,clsPrefix:this.mergedClsPrefix,showArrow:this.showArrow,maxTagCount:this.maxTagCount,ellipsisTagPopoverProps:this.ellipsisTagPopoverProps,bordered:this.mergedBordered,active:this.activeWithoutMenuOpen||this.mergedShow,pattern:this.pattern,placeholder:this.localizedPlaceholder,selectedOption:this.selectedOption,selectedOptions:this.selectedOptions,multiple:this.multiple,renderTag:this.renderTag,renderLabel:this.renderLabel,filterable:this.filterable,clearable:this.clearable,disabled:this.mergedDisabled,size:this.mergedSize,theme:this.mergedTheme.peers.InternalSelection,labelField:this.labelField,valueField:this.valueField,themeOverrides:this.mergedTheme.peerOverrides.InternalSelection,loading:this.loading,focused:this.focused,onClick:this.handleTriggerClick,onDeleteOption:this.handleDeleteOption,onPatternInput:this.handlePatternInput,onClear:this.handleClear,onBlur:this.handleTriggerBlur,onFocus:this.handleTriggerFocus,onKeydown:this.handleKeydown,onPatternBlur:this.onTriggerInputBlur,onPatternFocus:this.onTriggerInputFocus,onResize:this.handleTriggerOrMenuResize,ignoreComposition:this.ignoreComposition},{arrow:()=>{var e;return[(e=this.$slots).arrow?.call(e)]}})}),X(l,{ref:`followerRef`,show:this.mergedShow,to:this.adjustedTo,teleportDisabled:this.adjustedTo===s.tdkey,containerClass:this.namespace,width:this.consistentMenuWidth?`target`:void 0,minWidth:`target`,placement:this.placement},{default:()=>X(J,{name:`fade-in-scale-up-transition`,appear:this.isMounted,onAfterLeave:this.handleMenuAfterLeave},{default:()=>{var e;return this.mergedShow||this.displayDirective===`show`?((e=this.onRender)==null||e.call(this),ce(X(vt,Object.assign({},this.menuProps,{ref:`menuRef`,onResize:this.handleTriggerOrMenuResize,inlineThemeDisabled:this.inlineThemeDisabled,virtualScroll:this.consistentMenuWidth&&this.virtualScroll,class:[`${this.mergedClsPrefix}-select-menu`,this.themeClass,this.menuProps?.class],clsPrefix:this.mergedClsPrefix,focusable:!0,labelField:this.labelField,valueField:this.valueField,autoPending:!0,nodeProps:this.nodeProps,theme:this.mergedTheme.peers.InternalSelectMenu,themeOverrides:this.mergedTheme.peerOverrides.InternalSelectMenu,treeMate:this.treeMate,multiple:this.multiple,size:this.menuSize,renderOption:this.renderOption,renderLabel:this.renderLabel,value:this.mergedValue,style:[this.menuProps?.style,this.cssVars],onToggle:this.handleToggle,onScroll:this.handleMenuScroll,onFocus:this.handleMenuFocus,onBlur:this.handleMenuBlur,onKeydown:this.handleMenuKeydown,onTabOut:this.handleMenuTabOut,onMousedown:this.handleMenuMousedown,show:this.mergedShow,showCheckmark:this.showCheckmark,resetMenuOnOptionsChange:this.resetMenuOnOptionsChange,scrollbarProps:this.scrollbarProps}),{empty:()=>{var e;return[(e=this.$slots).empty?.call(e)]},header:()=>{var e;return[(e=this.$slots).header?.call(e)]},action:()=>{var e;return[(e=this.$slots).action?.call(e)]}}),this.displayDirective===`show`?[[B,this.mergedShow],[c,this.handleMenuClickOutside,void 0,{capture:!0}]]:[[c,this.handleMenuClickOutside,void 0,{capture:!0}]])):null}})})]}))}});export{Ae as n,$ as r,Ft as t};