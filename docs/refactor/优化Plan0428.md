...
- [x] **Step 3.1.1: 实现 EventBus 核心（pub/sub 模式）**
...
- [x] **Step 3.1.2: 实现内置 Handler——信号执行与日志记录**
...
- [x] **Step 3.1.4: 在 BacktestAppService 中集成 EventBus（可选开关）**
...
- [x] **Step 3.2.1: 创建 SQLite 数据库连接管理**
...
- [x] **Step 3.2.3: 实现 OrderRepository**
...
- [x] **Step 3.4.1: 改造 BacktestAppService 支持多策略并行评估**
...
- [x] **Step 3.6.1: 将 xtquant SDK 移出 src/ 目录并更新 .gitignore**
...
- [x] **Step 3.6.2: 更新 QMT Gateway import——支持动态 fallback 机制**
...
- [x] **Step 3.6.3: 更新 pyproject.toml——xtquant 作为可选依赖**
