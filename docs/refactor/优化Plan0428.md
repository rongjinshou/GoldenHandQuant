...
- [ ] **Step 1.2.1: 创建 PriceLimit 值对象与计算函数**
...
- [ ] **Step 1.2.3: 在 MockTradeGateway 中集成涨跌停校验**
...
- [ ] **Step 1.3.3: 在 BacktestAppService 中集成可交易检查**
...
- [ ] **Step 1.4.3: 重构 run_backtest.py 使用配置文件**
...
- [ ] **Step 1.5.2: 扩展 PerformanceEvaluator 测试**
...
- [ ] **Step 1.6.3: 替换 backtest_app.py 和 trading_app.py 中的宽泛 except**
...
- [ ] **Step 1.7.1: 从 IMarketGateway 移除 get_all_timestamps()**
...
- [ ] **Step 1.7.2: 将 get_all_timestamps() 移至 IBacktestMarketGateway**
...
- [ ] **Step 1.7.3: 从 QmtMarketGateway 移除 get_all_timestamps()**
...
- [ ] **Step 2.1.3: 改造 OrderService 接受 RiskChain**
...
- [ ] **Step 2.2.2: 集成到 BacktestAppService**
...
- [ ] **Step 2.3.1: 将 BacktestReport 改为 frozen=True dataclass 并添加计算 property**
...
- [ ] **Step 2.3.2: 简化 PerformanceEvaluator——仅聚合数据，不持有计算逻辑**
...
- [ ] **Step 2.3.3: 更新测试——验证 property 计算而非独立函数**
...
- [ ] **Step 2.4.1: 创建 AccountRepository 领域实体**
...
- [ ] **Step 2.4.2: 更新 AccountGateway 协议——支持 account_id 参数化**
...
- [ ] **Step 2.4.3: 改造 MockTradeGateway 支持多账户**
...
- [ ] **Step 2.4.4: 编写 AccountRepository 测试**
...
- [ ] **Step 2.4.5: 消除硬编码 "MOCK_ACCOUNT"——更新现有调用方**
