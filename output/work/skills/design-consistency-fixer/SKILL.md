...
`<target-root>` 是包含 ShopHub `code/`、`test-cases/`、`maven-settings.xml`、`design-docs/` 的项目根，与传给 `apply.sh` 的参数一致。评测平台默认是：

```bash
TARGET="/app/code/judge-assets/02_04_design_implementation_consistency"
