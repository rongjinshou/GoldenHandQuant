...
public class CartValidationService {
     ...
     *
     * <p>The limit is the runtime-overridable config key {@code cart.max-items}
     * (design-docs/附录B, default 100) — read through {@link RuntimeConfigRegistry}
     * so an admin override takes effect immediately.
     *
