...
public class PaymentValidator {
    ...
    public void validate(PayRequest request, OrderDto order) {
        ...
        // Validate order status is payable (README §7: ORDER_STATUS_CONFLICT/409 —
        // in the real request flow, OrderQueryService.getPayableOrder() already
        // enforces this before validate() is reached; kept here so this validator
        // rejects a wrong-status order correctly if ever invoked standalone).
