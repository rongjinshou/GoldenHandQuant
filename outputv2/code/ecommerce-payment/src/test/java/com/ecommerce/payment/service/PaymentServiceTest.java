...
class PaymentServiceTest {
    ...
    void testPay_validRequest_createsPaymentRecord() {
        ...
        // Order is looked up through the cross-module OrderQueryService
        // (design-docs/09 §1), never via direct SQL against the orders table.
        ...
        // Verify the order was looked up through OrderQueryService
