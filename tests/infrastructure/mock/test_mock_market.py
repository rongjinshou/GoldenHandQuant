...
class TestMockMarketGateway:
    def test_add_bars_should_classify_by_timeframe(self):
        ...
        bar_1m = Bar(symbol="S1", timeframe=Timeframe.MIN_1, timestamp=now,
                     open=10, high=10, low=10, close=10, volume=100)
        bar_1d = Bar(symbol="S1", timeframe=Timeframe.DAY_1, timestamp=now,
                     open=10, high=10, low=10, close=10, volume=100)
    ...
    def test_get_recent_bars_should_filter_by_timeframe_and_time(self):
        ...
        bars = [
            Bar(symbol="S1", timeframe=Timeframe.MIN_1, timestamp=now - timedelta(minutes=2),
                open=10, high=10, low=10, close=10, volume=100),
            Bar(symbol="S1", timeframe=Timeframe.MIN_1, timestamp=now - timedelta(minutes=1),
            ...
            Bar(symbol="S1", timeframe=Timeframe.MIN_1, timestamp=now + timedelta(minutes=1),
                open=13, high=13, low=13, close=13, volume=100),  # Future
        ]
