...
def test_turnover_rate_basic():
    snapshots = [
        DailySnapshot(date=datetime(2024, 6, 10), total_asset=100000, available_cash=50000,
                      market_value=50000, pnl=0, return_rate=0),
        DailySnapshot(date=datetime(2024, 6, 11), total_asset=101000, available_cash=40000,
                      market_value=61000, pnl=1000, return_rate=0.01),
    ]
    trades = [
        TradeRecord(symbol="A", direction=OrderDirection.BUY, execute_at=datetime(2024, 6, 11),
